...
public class OpenAiBusiness extends ServiceImpl<PandoraOpenaiUserMapper, PandoraOpenaiUser> {
    ...
    public R<?>  updateChat(ChatLog chatLog) {
        ...
        ChatLog chatGptChat = new ChatLog(1L,-1L,chatLog.getSenderGuId(),getChatGptRes(chatLog.getChatLogContent()),"gpt", null);
    ...
    public String getGptImages (String question) {
