...
public final class WalletGrpc {
  ...
  private static final int METHODID_GET_DELEGATED_RESOURCE_ACCOUNT_INDEX = 72;
  private static final int METHODID_LIST_PROPOSALS = 73;
  private static final int METHODID_GET_PAGINATED_PROPOSAL_LIST = 74;
  private static final int METHODID_GET_PROPOSAL_BY_ID = 75;
  private static final int METHODID_LIST_EXCHANGES = 76;
  private static final int METHODID_GET_PAGINATED_EXCHANGE_LIST = 77;
  private static final int METHODID_GET_EXCHANGE_BY_ID = 78;
  private static final int METHODID_GET_CHAIN_PARAMETERS = 79;
  private static final int METHODID_GET_ASSET_ISSUE_LIST = 80;
  private static final int METHODID_GET_PAGINATED_ASSET_ISSUE_LIST = 81;
  private static final int METHODID_TOTAL_TRANSACTION = 82;
  private static final int METHODID_GET_NEXT_MAINTENANCE_TIME = 83;
  private static final int METHODID_GET_TRANSACTION_SIGN = 84;
  private static final int METHODID_GET_TRANSACTION_SIGN2 = 85;
  private static final int METHODID_CREATE_ADDRESS = 86;
  private static final int METHODID_EASY_TRANSFER_ASSET = 87;
  private static final int METHODID_EASY_TRANSFER_ASSET_BY_PRIVATE = 88;
  private static final int METHODID_EASY_TRANSFER = 89;
  private static final int METHODID_EASY_TRANSFER_BY_PRIVATE = 90;
  private static final int METHODID_GENERATE_ADDRESS = 91;
  private static final int METHODID_GET_TRANSACTION_INFO_BY_ID = 92;
  private static final int METHODID_ACCOUNT_PERMISSION_UPDATE = 93;
  private static final int METHODID_ADD_SIGN = 94;
  private static final int METHODID_GET_TRANSACTION_SIGN_WEIGHT = 95;
  private static final int METHODID_GET_TRANSACTION_APPROVED_LIST = 96;
  private static final int METHODID_GET_NODE_INFO = 97;
  private static final int METHODID_GET_REWARD_INFO = 98;
  private static final int METHODID_GET_BROKERAGE_INFO = 99;
  private static final int METHODID_UPDATE_BROKERAGE = 100;
  private static final int METHODID_CREATE_SHIELDED_TRANSACTION = 101;
  private static final int METHODID_GET_MERKLE_TREE_VOUCHER_INFO = 102;
  private static final int METHODID_SCAN_NOTE_BY_IVK = 103;
  private static final int METHODID_SCAN_AND_MARK_NOTE_BY_IVK = 104;
  private static final int METHODID_SCAN_NOTE_BY_OVK = 105;
  private static final int METHODID_GET_SPENDING_KEY = 106;
  private static final int METHODID_GET_EXPANDED_SPENDING_KEY = 107;
  private static final int METHODID_GET_AK_FROM_ASK = 108;
  private static final int METHODID_GET_NK_FROM_NSK = 109;
  private static final int METHODID_GET_INCOMING_VIEWING_KEY = 110;
  private static final int METHODID_GET_DIVERSIFIER = 111;
  private static final int METHODID_GET_NEW_SHIELDED_ADDRESS = 112;
  private static final int METHODID_GET_ZEN_PAYMENT_ADDRESS = 113;
  private static final int METHODID_GET_RCM = 114;
  private static final int METHODID_IS_SPEND = 115;
  private static final int METHODID_CREATE_SHIELDED_TRANSACTION_WITHOUT_SPEND_AUTH_SIG = 116;
  private static final int METHODID_GET_SHIELD_TRANSACTION_HASH = 117;
  private static final int METHODID_CREATE_SPEND_AUTH_SIG = 118;
  private static final int METHODID_CREATE_SHIELD_NULLIFIER = 119;
  private static final int METHODID_CREATE_SHIELDED_CONTRACT_PARAMETERS = 120;
  private static final int METHODID_CREATE_SHIELDED_CONTRACT_PARAMETERS_WITHOUT_ASK = 121;
  private static final int METHODID_SCAN_SHIELDED_TRC20NOTES_BY_IVK = 122;
  private static final int METHODID_SCAN_SHIELDED_TRC20NOTES_BY_OVK = 123;
  private static final int METHODID_IS_SHIELDED_TRC20CONTRACT_NOTE_SPENT = 124;
  private static final int METHODID_GET_TRIGGER_INPUT_FOR_SHIELDED_TRC20CONTRACT = 125;
  private static final int METHODID_CREATE_COMMON_TRANSACTION = 126;
  private static final int METHODID_GET_TRANSACTION_INFO_BY_BLOCK_NUM = 127;
  private static final int METHODID_MARKET_SELL_ASSET = 128;
  private static final int METHODID_MARKET_CANCEL_ORDER = 129;
  private static final int METHODID_GET_MARKET_ORDER_BY_ACCOUNT = 130;
  private static final int METHODID_GET_MARKET_ORDER_BY_ID = 131;
  private static final int METHODID_GET_MARKET_PRICE_BY_PAIR = 132;
  private static final int METHODID_GET_MARKET_ORDER_LIST_BY_PAIR = 133;
  private static final int METHODID_GET_MARKET_PAIR_LIST = 134;
