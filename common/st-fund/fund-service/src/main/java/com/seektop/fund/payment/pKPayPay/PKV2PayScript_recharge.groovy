 ...
 * @date 2022-02-11
 */
class PKV2PayScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(PKV2PayScript_recharge.class)
    ...
    private void prepareScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount payment, RechargePrepareDO req, GlRechargeResult result, String payType) {
        ...
        JSONObject dataJSON = json.getJSONObject("bankInfo")
        BankInfo bankInfo = new BankInfo()
        bankInfo.setName(dataJSON.getString("account"))
        bankInfo.setBankId(-1)
        bankInfo.setBankName(dataJSON.getString("bank"))
        bankInfo.setBankBranchName(dataJSON.getString("zh"))
