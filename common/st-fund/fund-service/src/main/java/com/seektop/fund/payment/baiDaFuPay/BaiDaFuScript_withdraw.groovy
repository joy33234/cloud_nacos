package com.seektop.fund.payment.baiDaFuPay
 ...
 * @auth Otto
 */
class BaiDaFuScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(BaiDaFuScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("BaiDaFuScript_Transfer_params: {}", params)
        ...
        log.info("BaiDaFuScript_Transfer_resStr: {} , orderId:{}", resStr , req.getOrderId())
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("BaiDaFuScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        log.info("BaiDaFuScript_notify_Sign: 回调资料错误或验签失败，orderId ：{}" , orderId )
        return null
    }
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("BaiDaFuScript_TransferQuery_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("BaiDaFuScript_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("BaiDaFuScript_QueryBalance_reqMap: {}", JSON.toJSONString(params))
        ...
        log.info("BaiDaFuScript_QueryBalance_resStr: {}", resStr)
