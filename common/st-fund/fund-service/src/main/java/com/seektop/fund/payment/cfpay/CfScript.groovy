...
public class CfScript {
    ...
    private static final Logger log = LoggerFactory.getLogger(CfScript.class)
    ...
    public void pay(Object[] args) {
        ...
        try {
            ...
            log.info("CfScript_Prepare_resMap:{}", JSON.toJSONString(params))
            ...
            log.info("CfScript_Prepare_resStr:{}", resStr)
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("CfScript_notify_resp:{}", JSON.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("CfScript_query_params_orderId:{}", orderId)
        ...
        log.info("CfScript_query_resStr:{}", resStr)
    ...
    public WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        try {
            ...
            log.info("CfScript_doTransfer_resMap:{}", JSON.toJSONString(params))
            ...
            log.info("CfScript_doTransfer_resStr:{}", resStr)
        } catch (Exception e) {
            e.printStackTrace()
        }
    ...
    public WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("CfScript_transfer_notify_resMap:{}", JSON.toJSONString(resMap))
        JSONObject json = JSON.parseObject(resMap.get("reqBody"))
        String orderId = json.getString("out_trade_no")
    ...
    public WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("CfScript_TransferQuery_orderId_{}", orderId)
        ...
        log.info("CfScript_TransferQuery_resStr:{}", resStr)
...
//订单状态progress=>申请中 withdrawing => 下发中 success => 成功 failed => 退回    商户返回出款状态：0成功，1失败,2处理中
    ...
    public BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("CfScript_queryBalance_headParams:{}", headParams)
        ...
        log.info("CfScript_queryBalance_resStr:{}", resStr)
