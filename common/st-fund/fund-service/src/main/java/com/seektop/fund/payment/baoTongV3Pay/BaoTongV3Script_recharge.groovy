 ...
 * @date 2021-12-09
 */
class BaoTongV3Script_recharge {

    private static final Logger log = LoggerFactory.getLogger(BaoTongV3Script_recharge.class)
    ...
    private void prepareScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount payment, RechargePrepareDO req, GlRechargeResult result, String payType) {
        ...
        log.info("BaoTongV3Script_Prepare_Params:{} url: {}", JSON.toJSONString(params) , payment.getPayUrl())
        ...
        log.info("BaoTongV3Script_Prepare_resStr:{} , orderId :{}" , restr, req.getOrderId())
    ...
    RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("BaoTongV3Script_Notify_resMap:{}", JSON.toJSONString(resMap))
        ...
        log.info("BaoTongV3Script_RechargeNotify_Sign: 回调资料错误或验签失败 单号：{}", orderid)
        return null
    ...
    RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("BaoTongV3Script_Query_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("BaoTongV3Script_Query_resStr:{}", resStr)
