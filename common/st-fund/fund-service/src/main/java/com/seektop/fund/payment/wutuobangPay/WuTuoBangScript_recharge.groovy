 ...
 * @date 2021-07-15
 */
public class WuTuoBangScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(WuTuoBangScript_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String productId)  {
        ...
        log.info("WuTuoBangScript_recharge_prepare_params = {}", JSONObject.toJSONString(params))
        String resStr = okHttpUtil.post(account.getPayUrl() + "/api/pay/create_order", params, requestHeader)
        log.info("WuTuoBangScript_recharge_prepare_resp = {}", resStr)
        ...
        if ("SUCCESS" != (json.getString("retCode")) || StringUtils.isEmpty(dataJSON.getString("payJumpUrl"))) {
            result.setErrorCode(FundConstant.RechargeErrorCode.PAYMENT)
            result.setErrorMsg(json.getString("errDes") == null ? "创建订单失败" : json.getString("errDes"))
            return
        }
        result.setRedirectUrl(dataJSON.getString("payJumpUrl"))
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("WuTuoBangScript_notify = {}", JSONObject.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("WuTuoBangScript_query_params:{}", JSON.toJSONString(params))
        ...
        log.info("WuTuoBangScript_query_resp:{}", resp)
