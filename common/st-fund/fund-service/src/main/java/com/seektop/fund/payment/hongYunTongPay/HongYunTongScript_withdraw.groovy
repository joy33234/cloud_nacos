 ...
 * @auth Otto
 */
class HongYunTongScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(HongYunTongScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("HongYunTongScript_Transfer_params: {}", params)
        ...
        log.info("HongYunTongScript_Transfer_resStr: {} , orderId:{}", resStr , req.getOrderId())
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("HongYunTongScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("HongYunTongScript_TransferQuery_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("HongYunTongScript_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("HongYunTongScript_QueryBalance_reqMap: {}", JSON.toJSONString(params))
        ...
        log.info("HongYunTongScript_QueryBalance_resStr: {}", resStr)
