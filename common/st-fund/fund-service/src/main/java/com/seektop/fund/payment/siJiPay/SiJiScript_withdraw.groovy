 ...
 * @auth Otto
 */
public class SiJiScript_withdraw {


    private static final Logger log = LoggerFactory.getLogger(SiJiScript_withdraw.class)
    ...
    public WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("SiJiScript_doTransfer_params:{} , url:{}", JSON.toJSONString(params) , account.getPayUrl())
        ...
        log.info("SiJiScript_doTransfer_resp:{} , orderId:{}", resStr , req.getOrderId())
    ...
    public WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("SiJiScript_doTransferNotify_resp:{}, orderId:{}", JSON.toJSONString(resMap) , orderId )
    ...
    public WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("SiJiScript_doTransferQuery_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("SiJiScript_doTransferQuery_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
        JSONObject json = JSON.parseObject(resStr)
        ...
        if (json.getString("status") == ("0")) {
            notify.setStatus(0)
        } else if (json.getString("status") == ("4") || json.getString("status") == ("11") || json.getString("status") == ("5")  ) {
            notify.setStatus(1)
        } else {
            notify.setStatus(2)
        }
    ...
    public BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("SiJiScript_Query_Balance_Params: {}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("SiJiScript_Query_Balance_resStr: {}", resStr)
    ...
    public static String encrypt(String content, String key) {
        try {
            ...
            log.info("SiJiScript_doTransfer_params:加密失败")
            e.printStackTrace();
        }
        return null;
    }
    ...
    public static String decrypt(String encryptStr, String key) {
        try {
            ...
            log.info("SiJiScript_doTransferNotify_resp: 解密失败" )
            e.printStackTrace();
        }
        return null;
    }
