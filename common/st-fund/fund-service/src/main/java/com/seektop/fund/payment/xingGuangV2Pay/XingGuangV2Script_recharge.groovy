 ...
 * @auth otto
 */
public class XingGuangV2Script_recharge {

    private static final Logger log = LoggerFactory.getLogger(XingGuangV2Script_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String gateway) throws GlobalException {
        ...
        //公钥借栏位放通道代码  wxhb :微信红包  wx2:微信话费
        if(gateway == "wxhb" && account.getPublicKey()=="wx2"){
                gateway = account.getPublicKey()
        }
        ...
        log.info("XingGuangV2Script_recharge_prepare_params:{}", JSON.toJSONString(params))
        ...
        log.info("XingGuangV2Script_recharge_prepare_resp:{}  , orderId:{}", resStr ,req.getOrderId())
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("XingGuangV2Script_notify_resp:{}", resMap)
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("XingGuangV2Script_query_params:{}", JSON.toJSONString(params))
        ...
        log.info("XingGuangV2Script_query_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
