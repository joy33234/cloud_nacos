 ...
 * @auth joy
 */
public class SevenElevenScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(SevenElevenScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("SevenElevenScrit_transfer_params:{}", JSON.toJSONString(map))
        ...
        log.info("SevenElevenScrit_transfer_resp:{}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("SevenElevenScrit_withdrawNotify_resp:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("SevenElevenScrit_transferQuery_params:{}", JSON.toJSONString(map))
        GlRequestHeader requestHeader =
        ...
        log.info("SevenElevenScrit_transferQuery_resp:{}", resStr)
        JSONObject responseJSON = JSONObject.parseObject(resStr)
