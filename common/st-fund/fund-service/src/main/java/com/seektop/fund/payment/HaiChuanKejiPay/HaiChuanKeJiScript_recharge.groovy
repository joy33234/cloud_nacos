...
public class HaiChuanKeJiScript_recharge {
    ...
    private static final Logger log = LoggerFactory.getLogger(HaiChuanKeJiScript_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String payType) throws GlobalException {
        ...
        log.info("HaiChuanKejiScript_recharge_prepare_params:{}", JSON.toJSONString(params))
        ...
        log.info("HaiChuanKejiScript_recharge_prepare_resp:{}", resStr)
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("HaiChuanKejiScript_notify_resp:{}", JSON.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        toSign += "&KEY=" + account.getPrivateKey()
        params.put("SIGN_DAT", MD5.md5(toSign))
        log.info("HaiChuanKejiScript_query_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader = GlRequestHeader.builder()
...
//        String resStr = okHttpUtil.postJSON(account.getPayUrl() + SERVER_QUERY_URL, JSON.toJSONString(params), requestHeader)
        ...
        log.info("HaiChuanKejiScript_query_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
