...
class PingAnScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(PingAnScript_recharge.class)
    ...
    private void prepareScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount payment, RechargePrepareDO req, GlRechargeResult result, String PayTypeId) {
        ...
        log.info("PingAnScript_Prepare_Params:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("PingAnScript_Prepare_resStr:{}", restr)
    ...
    RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("PingAnScript_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("PingAnScript_Query_reqMap:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("PingAnScript_Query_resStr:{}", resStr)
