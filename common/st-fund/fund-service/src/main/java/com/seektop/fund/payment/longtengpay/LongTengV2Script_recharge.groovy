 ...
 * @auth joy
 */
public class LongTengV2Script_recharge {


    private static final Logger log = LoggerFactory.getLogger(LongTengV2Script_recharge.class)
    ...
    private void prepare(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String payType) throws GlobalException {
        ...
        if (json == null || "1000" != json.getString("code") || StringUtils.isEmpty(json.getString("pay_url"))) {
