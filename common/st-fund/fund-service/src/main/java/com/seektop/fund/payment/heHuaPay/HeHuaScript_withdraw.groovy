 ...
 * @auth Otto
 */
public class HeHuaScript_withdraw {


    private static final Logger log = LoggerFactory.getLogger(HeHuaScript_withdraw.class)
    ...
    public WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("HeHuaScript_doTransfer_params：{}", JSON.toJSONString(params))
        ...
        log.info("HeHuaScript_doTransfer_resp:{} , orderId :{}", resStr ,  params.get("orderid")  )
    ...
    public WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("HeHuaScript_doTransferNotify_resp:{}", JSON.toJSONString(resMap))
    ...
    public WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("HeHuaScript_doTransferQuery_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("HeHuaScript_doTransferQuery_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
        JSONObject json = JSON.parseObject(resStr)
    ...
    public BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("HeHuaScript_Query_Balance_Params: {}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("HeHuaScript_Query_Balance_resStr: {}", resStr)
