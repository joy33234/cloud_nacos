 ...
 * @auth otto
 */
public class GuangScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(GuangScript_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String gateway) throws GlobalException {
        ...
        log.info("GuangScript_recharge_prepare_params:{}", JSON.toJSONString(params))
        ...
        log.info("GuangScript_recharge_prepare_resp:{}", resStr)
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("GuangScript_notify_resp:{}", resMap)
        ...
        if (StringUtils.isNotEmpty(signMap.get("out_trade_no")) && toSign == thirdSign) {
            return this.payQuery(okHttpUtil, account, signMap.get("out_trade_no"))
        }

        log.info("GuangScript_notify_Sign: 回调资料错误或验签失败，单号：{}", signMap.get("out_trade_no"))
        return null
    }
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("GuangScript_query_params:{}", JSON.toJSONString(params))
        ...
        log.info("GuangScript_query_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
