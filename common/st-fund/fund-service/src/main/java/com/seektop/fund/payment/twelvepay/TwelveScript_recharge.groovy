 ...
 * @auth joy
 */
public class TwelveScript_recharge {


    private static final Logger log = LoggerFactory.getLogger(TwelveScript_recharge.class)
    ...
    private void prepare(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String payType) throws GlobalException {
        ...
        log.info("TwelveScript_recharge_prepare_Params:{}", JSON.toJSONString(params))
        ...
        log.info("TwelveScript_recharge_prepare_requestHeader:{}", JSON.toJSONString(requestHeader))
        String resStr = okHttpUtil.post(account.getPayUrl() + "/deposit", params, requestHeader)
        log.info("TwelveScript_recharge_prepare_resp:{}", resStr)
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("TwelveScript_notify_resp:{}", JSON.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("TwelveScript_query_headParams:{}", JSON.toJSONString(params))
        ...
        log.info("TwelveScript_query_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
