 ...
 * @auth joy
 */
public class JiaHongScript_recharge {


    private static final Logger log = LoggerFactory.getLogger(JiaHongScript_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String payType) throws GlobalException {
        ...
        log.info("JiaHongScript_recharge_prepare_params:{}", JSON.toJSONString(params))
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("JiaHongScript_notify_resp:{}", JSON.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("JiaHongScript_query_params:{}", JSON.toJSONString(params))
        ...
        log.info("JiaHongScript_query_resp:{}", resStr)
        ...
        if ("00" == (json.getString("trade_state"))) {
            ...
            String amount = json.getString("trade_amt").replaceAll(",","");
            pay.setAmount(new BigDecimal(amount).setScale(2,RoundingMode.DOWN))
