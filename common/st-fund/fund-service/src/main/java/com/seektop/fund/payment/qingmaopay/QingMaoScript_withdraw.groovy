package com.seektop.fund.payment.qingmaopay
...
public class QingMaoScript_withdraw {
    ...
    private static final Logger log = LoggerFactory.getLogger(QingMaoScript_withdraw.class)
    ...
    public WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("QingMaoScript_doTransfer_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
                this.getRequestHeard(req.getUserId() + "", req.getUsername(), req.getOrderId(), GlActionEnum.WITHDRAW.getCode(), merchantAccount.getChannelId(), merchantAccount.getChannelName())

        String resStr = okHttpUtil.postJSON(merchantAccount.getPayUrl() + SERVER_DF_PAY_URL, JSON.toJSONString(params), requestHeader)
        log.info("QingMaoScript_doTransfer_resp:{}", resStr)
    ...
    public WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("QingMaoScript_doTransferNotify_resp:{}", JSON.toJSONString(resMap))
    ...
    public WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        params.put("SIGN_DAT", MD5.md5(toSign))
        log.info("QingMaoScript_doTransferQuery_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("QingMaoScript_doTransferQuery_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
        JSONObject json = JSON.parseObject(resStr)
    ...
    public BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        toSign += "&KEY=" + merchantAccount.getPrivateKey()
        params.put("SIGN_DAT", MD5.md5(toSign))
        log.info("QingMaoScript_queryBalance_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("QingMaoScript_queryBalance_resp:{}", resStr)
