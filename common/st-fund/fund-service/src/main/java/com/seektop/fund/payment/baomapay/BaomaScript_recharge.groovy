 ...
 * @Date 20210415
 */
public class BaomaScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(BaomaScript_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result)  {
        ...
        log.info("baoma_debug_jsonContent:{}",jsonContent)
        ...
        log.info("BaomaScript_recharge_prepare_params = {}", JSON.toJSONString(map))
        String resStr = okHttpUtil.postJSON(account.getPayUrl() + "/Doc/PayOrder", jsonContent, requestHeader)
        log.info("BaomaScript_recharge_prepare_resp = {}", resStr)
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("BaomaScript_notify = {}", JSONObject.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("BaomaScript_query_params:{}", jsonContent)
        GlRequestHeader requestHeader =
        ...
        log.info("BaomaScript_query_resp:{}", resp)
    ...
    private String getContent(TreeMap<String, String> map, GlPaymentMerchantaccount account) {
        ...
        log.info("baoma_debug_publickey:{}",account.getPublicKey())

        String jsonString = JSON.toJSONString(map)

        log.info("baoma_debug_jsonString:{}",jsonString)

        // 根据key排序asc的str字符串
        String sortStr = sortSign(map);

        log.info("baoma_debug_sortStr:{}",sortStr)
        ...
        log.info("baoma_debug_signDesKey:{}",signDesKey)
        // 支付加密类型
        String signtype = "MD5";

        // 公钥加密
        String data = encrypt(jsonString, signDesKey);
        log.info("baoma_debug_data:{}",data)
        // 私钥签名
