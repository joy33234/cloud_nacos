 ...
 *
 */
class PaiXiangScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(PaiXiangScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        paramMap.put("subbranch", req.getBankName())
        ...
        log.info("PaiXiangScript_Transfer_Params: {}", JSON.toJSONString(paramMap))
        ...
        log.info("PaiXiangScript_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("PaiXiangScript_Transfer_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("PaiXiangScript_Transfer_Query_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        log.info("PaiXiangScript_Transfer_Query_resStr: {}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        String toSign = MD5.toAscii(paramMap) + "&key=" + merchantAccount.getPrivateKey()
        paramMap.put("pay_md5sign", MD5.md5(toSign).toUpperCase())
        log.info("PaiXiangScript_Query_Balance_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        log.info("PaiXiangScript_Query_Balance_resStr: {}", resStr)
