 ...
 * @auth joy
 */
public class ShanDianScript_recharge {


    private static final Logger log = LoggerFactory.getLogger(ShanDianScript_recharge.class)
    ...
    private void prepare(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String payType) throws GlobalException {
        ...
        log.info("ShanDianScript_recharge_prepare_Params:{}", JSON.toJSONString(params))
        ...
        log.info("ShanDianScript_recharge_prepare_resp:{}", resStr)
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("ShanDianScript_notify_resp:{}", JSON.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("ShanDianScript_query_headParams:{}", JSON.toJSONString(params))
        ...
        log.info("ShanDianScript_query_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
