 ...
 *
 */
class WanGuoScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(WanGuoScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("WanGuoScript_Transfer_Params: {}", JSON.toJSONString(paramMap))
        ...
        log.info("WanGuoScript_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("WanGuoScript_Transfer_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("WanGuoScript_Transfer_Query_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        log.info("WanGuoScript_Transfer_Query_resStr: {}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        String toSign = MD5.toAscii(paramMap) + "&key=" + merchantAccount.getPrivateKey()
        paramMap.put("pay_md5sign", MD5.md5(toSign).toUpperCase())
        log.info("WanGuoScript_Query_Balance_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        log.info("WanGuoScript_Query_Balance_resStr: {}", resStr)
