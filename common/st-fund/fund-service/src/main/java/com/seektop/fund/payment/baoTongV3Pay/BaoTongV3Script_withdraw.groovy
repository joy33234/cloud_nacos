package com.seektop.fund.payment.baoTongV3Pay
 ...
 * @date 2021-12-10
 */
public class BaoTongV3Script_withdraw {

    private static final Logger log = LoggerFactory.getLogger(BaoTongV3Script_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("BaoTongV3Script_Transfer_params: {}", JSON.toJSONString(params))
        ...
        log.info("BaoTongV3Script_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        this.glPaymentChannelBankBusiness = BaseScript.getResource(args[3], ResourceEnum.GlPaymentChannelBankBusiness) as GlPaymentChannelBankBusiness
        log.info("BaoTongV3Script_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        if ( RSASignature.doCheck(s.toString(), resMap.get("sign"), merchant.getPublicKey())) {
            ...
            log.info("BaoTongV3Script_WithdrawNotify_Sign: 回调资料错误或验签失败 单号：{}", orderid)
            return null
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("BaoTongV3Script_TransferQuery_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("BaoTongV3Script_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("BaoTongV3Script_QueryBalance_reqMap: {}", JSON.toJSONString(params))
        ...
        log.info("BaoTongV3Script_QueryBalance_resStr: {}", resStr)
