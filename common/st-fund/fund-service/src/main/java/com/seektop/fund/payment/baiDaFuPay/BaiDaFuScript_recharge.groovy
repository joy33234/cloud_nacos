 ...
 * @date 2021-11-09
 * @auth otto
 * 配置需注意"公钥" 借用栏位放三方通道代码
 */
public class BaiDaFuScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(BaiDaFuScript_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String gateway) throws GlobalException {
        ...
        log.info("BaiDaFuScript_recharge_prepare_params:{}", JSON.toJSONString(params))
        ...
        log.info("BaiDaFuScript_recharge_prepare_resp:{}  , orderId:{}", resStr ,req.getOrderId())
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("BaiDaFuScript_notify_resp:{}", resMap)
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("BaiDaFuScript_query_params:{}", JSON.toJSONString(params))
        ...
        log.info("BaiDaFuScript_query_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
