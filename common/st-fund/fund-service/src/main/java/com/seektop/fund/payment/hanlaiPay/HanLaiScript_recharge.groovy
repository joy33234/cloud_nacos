...
class HanLaiScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(HanLaiScript_recharge.class)
    ...
    private void prepare(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount payment, RechargePrepareDO req, GlRechargeResult result) {
        ...
        log.info("HanLaiScript_Prepare_Params: {}", JSON.toJSONString(paramMap))
        ...
        log.info("HanLaiScript_Prepare_Resp: {}", restr)
    ...
    RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("HanLaiScript_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("HanLaiScript_Query_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        log.info("HanLaiScript_Query_resStr: {}", result)
