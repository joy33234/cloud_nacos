package com.seektop.fund.payment.youkuaitongpay
...
class YouKuaiTongScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(YouKuaiTongScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("YouKuaiTongScript_Transfer_params: {}", JSON.toJSONString(DataContentParms))
        ...
        log.info("YouKuaiTongScript_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("YouKuaiTongScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("YouKuaiTongScript_TransferQuery_reqMap:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("YouKuaiTongScript_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("YouKuaiTongScript_QueryBalance_reqMap: {}", JSON.toJSONString(DataContentParms))
        ...
        log.info("YouKuaiTongScript_QueryBalance_resStr: {}", resStr)
