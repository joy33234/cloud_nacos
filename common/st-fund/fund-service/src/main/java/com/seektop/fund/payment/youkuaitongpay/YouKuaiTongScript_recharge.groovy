...
class YouKuaiTongScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(YouKuaiTongScript_recharge.class)
    ...
    private void prepareScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount payment, RechargePrepareDO req, GlRechargeResult result, String payType) {
        try {
            ...
            log.info("YouKuaiTongScript_Prepare_Params:{}", JSON.toJSONString(DataContentParms))
            ...
            log.info("YouKuaiTongScript_Prepare_resStr:{}", restr)
    ...
    RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("YouKuaiTongScript_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("YouKuaiTongScript_Query_reqMap:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("YouKuaiTongScript_Query_resStr:{}", resStr)
