package com.seektop.fund.payment.daPaoPay
 ...
 * @auth Otto
 */
class DaPaoScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(DaPaoScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("DaPaoScript_Transfer_params: {}", params)
        ...
        log.info("DaPaoScript_Transfer_resStr: {}  , orderid :{}", resStr , req.getOrderId())
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        this.glPaymentChannelBankBusiness = BaseScript.getResource(args[3], ResourceEnum.GlPaymentChannelBankBusiness) as GlPaymentChannelBankBusiness
        log.info("DaPaoScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        if (StringUtils.isNotEmpty(orderId) && sign == md5Sign) {
            ...
            log.info("DaPaoScript_WithdrawNotify_Sign: 回调资料错误或验签失败，我方签名为：{}" , md5Sign )
            return null
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("DaPaoScript_TransferQuery_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("DaPaoScript_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("DaPaoScript_QueryBalance_reqMap: {}", JSON.toJSONString(params))
        ...
        log.info("DaPaoScript_QueryBalance_resStr: {}", resStr)
