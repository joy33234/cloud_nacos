package com.seektop.fund.payment.shandianPay
 ...
 * @auth joy
 */
public class ShanDianScript_withdraw {


    private static final Logger log = LoggerFactory.getLogger(ShanDianScript_withdraw.class)
    ...
    public WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("ShanDianScript_doTransfer_params：{}", JSON.toJSONString(params))
        ...
        log.info("ShanDianScript_doTransfer_resp:{}", resStr)
    ...
    public WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("ShanDianScript_doTransferNotify_resp:{}", JSON.toJSONString(resMap))
    ...
    public WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("ShanDianScript_doTransferQuery_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("ShanDianScript_doTransferQuery_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
        JSONObject json = JSON.parseObject(resStr)
    ...
    public BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("ShanDianScript_Query_Balance_Params: {}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("ShanDianScript_Query_Balance_resStr: {}", resStr)
