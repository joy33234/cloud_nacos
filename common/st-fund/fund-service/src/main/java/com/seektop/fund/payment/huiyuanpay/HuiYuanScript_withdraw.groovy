package com.seektop.fund.payment.huiyuanpay
...
public class HuiYuanScript_withdraw {
    ...
    private static final Logger log = LoggerFactory.getLogger(HuiYuanScript_withdraw.class)
    ...
    public WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("HuiYuanScript_doTransfer_params:{}", JSON.toJSONString(params))
        ...
        log.info("HuiYuanScript_doTransfer_resp:{}", resStr)
    ...
    public WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("HuiYuanScript_doTransferNotify_resp:{}", JSON.toJSONString(resMap))
    ...
    public WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        params.put("SIGN_DAT", MD5.md5(toSign))
        log.info("HuiYuanScript_doTransferQuery_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader = GlRequestHeader.builder()
        ...
        log.info("HuiYuanScript_doTransferQuery_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
        JSONObject json = JSON.parseObject(resStr)
    ...
    public BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        toSign += "&KEY=" + merchantAccount.getPrivateKey()
        params.put("SIGN_DAT", MD5.md5(toSign))
        log.info("HuiYuanScript_queryBalance_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader = GlRequestHeader.builder()
        ...
        log.info("HuiYuanScript_queryBalance_resp:{}", resStr)
