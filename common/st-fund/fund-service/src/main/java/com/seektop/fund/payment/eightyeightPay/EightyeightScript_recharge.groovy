...
class EightyeightScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(EightyeightScript_recharge.class)
    ...
    private void prepareScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount payment, RechargePrepareDO req, GlRechargeResult result, String channel) {
        ...
        log.info("EightyeightScript_Prepare_Params:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("EightyeightScript_Prepare_resStr:{}", restr)
    ...
    RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("EightyeightScript_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("EightyeightScript_Query_reqMap:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("EightyeightScript_Query_resStr:{}", resStr)
