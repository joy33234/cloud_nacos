 ...
 * @auth Otto
 */
class LingLingQiScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(LingLingQiScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("LingLingQiScript_Transfer_params: {}", params)
        ...
        log.info("LingLingQiScript_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        this.glPaymentChannelBankBusiness = BaseScript.getResource(args[3], ResourceEnum.GlPaymentChannelBankBusiness) as GlPaymentChannelBankBusiness
        log.info("LingLingQiScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        if (StringUtils.isNotEmpty(orderId) && sign == md5Sign) {
            ...
            log.info("LingLingQiScript_WithdrawNotify_Sign: 回调资料错误或验签失败，我方签名为：{}" , md5Sign )
            return null
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("LingLingQiScript_TransferQuery_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("LingLingQiScript_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("LingLingQiScript_QueryBalance_reqMap: {}", JSON.toJSONString(params))
        ...
        log.info("LingLingQiScript_QueryBalance_resStr: {}", resStr)
