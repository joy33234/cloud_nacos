package com.seektop.fund.payment.xingGuangV2Pay
 ...
 * @auth Otto
 */
class XingGuangV2Script_withdraw {

    private static final Logger log = LoggerFactory.getLogger(XingGuangV2Script_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("XingGuangV2Script_Transfer_params: {}  url:{} ", params  , merchantAccount.getPayUrl())
        ...
        log.info("XingGuangV2Script_Transfer_resStr: {} , orderId:{}", resStr , req.getOrderId())
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("XingGuangV2Script_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        log.info("XingGuangV2Script_notify_Sign: 回调资料错误或验签失败，orderId ：{}" , orderId )
        return null
    }
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("XingGuangV2Script_TransferQuery_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("XingGuangV2Script_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("XingGuangV2Script_QueryBalance_reqMap: {}", JSON.toJSONString(params))
        ...
        log.info("XingGuangV2Script_QueryBalance_resStr: {}", resStr)
