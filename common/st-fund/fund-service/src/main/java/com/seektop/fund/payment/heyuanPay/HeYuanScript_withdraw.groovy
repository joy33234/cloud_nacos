...
public class HeYuanScript_withdraw {
    ...
    private static final Logger log = LoggerFactory.getLogger(HeYuanScript_withdraw.class)
    ...
    public WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("HeYuanScript_doTransfer_params:{}", JSON.toJSONString(params))
        ...
        log.info("HeYuanScript_doTransfer_resp:{}", resStr)
    ...
    public WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("HeYuanScript_doTransferNotify_resp:{}", JSON.toJSONString(resMap))
    ...
    public WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        params.put("SIGN_DAT", MD5.md5(toSign))
        log.info("HeYuanScript_doTransferQuery_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("HeYuanScript_doTransferQuery_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
        JSONObject json = JSON.parseObject(resStr)
    ...
    public BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        toSign += "&KEY=" + merchantAccount.getPrivateKey()
        params.put("SIGN_DAT", MD5.md5(toSign))
        log.info("HeYuanScript_queryBalance_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("HeYuanScript_queryBalance_resp:{}", resStr)
