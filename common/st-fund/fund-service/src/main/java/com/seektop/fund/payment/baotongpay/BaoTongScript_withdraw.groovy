...
class BaoTongScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(BaoTongScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("BaoTongScript_Transfer_params: {}", JSON.toJSONString(DataContentParms))
        ...
        log.info("BaoTongScript_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("BaoTongScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("BaoTongScript_TransferQuery_reqMap:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("BaoTongScript_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("BaoTongScript_QueryBalance_reqMap: {}", JSON.toJSONString(DataContentParms))
        ...
        log.info("BaoTongScript_QueryBalance_resStr: {}", resStr)

        JSONObject json = JSON.parseObject(resStr)
        if (json != null) {
            BigDecimal balance = json.getJSONArray("money").getJSONObject(0).getBigDecimal("money")
