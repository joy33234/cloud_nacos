...
class JiaYinScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(JiaYinScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("JiaYinScript_Transfer_Params: {}", JSON.toJSONString(paramMap))
        ...
        log.info("JiaYinScript_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("JiaYinScript_Transfer_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("JiaYinScript_Transfer_Query_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        log.info("JiaYinScript_Transfer_Query_resStr: {}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("JiaYinScript_Query_Balance_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        String resStr = okHttpUtil.post(merchantAccount.getPayUrl() + "/Payment_Dfpay_getMchInfo.html", paramMap, 10L, requestHeader)
        log.info("JiaYinScript_Query_Balance_resStr: {}", resStr)
