...
class WanheScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(WanheScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("WanheScript_Transfer_params: {}", JSON.toJSONString(DataContentParms))
        ...
        log.info("WanheScript_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        this.glPaymentChannelBankBusiness = BaseScript.getResource(args[3], ResourceEnum.GlPaymentChannelBankBusiness) as GlPaymentChannelBankBusiness
        log.info("WanheScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("WanheScript_TransferQuery_reqMap:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("WanheScript_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("WanheScript_QueryBalance_reqMap: {}", JSON.toJSONString(DataContentParms))
        ...
        log.info("WanheScript_QueryBalance_resStr: {}", resStr)
