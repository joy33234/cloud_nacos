 ...
 * @date 2021-03-30
 */
class YonghengV3Script_withdraw {

    private static final Logger log = LoggerFactory.getLogger(YonghengV3Script_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("YonghengV3Script_Transfer_Params: {}", JSON.toJSONString(paramMap))
        ...
        log.info("YonghengV3Script_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("YonghengV3Script_Transfer_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("YonghengV3Script_Transfer_Query_Params: {}", JSON.toJSONString(paramMap))
        ...
        log.info("YonghengV3Script_Transfer_Query_resStr: {}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("YonghengV3Script_Query_Balance_Params: {}", JSON.toJSONString(paramMap))
        ...
        log.info("YonghengV3Script_Query_Balance_resStr: {}", resStr)
