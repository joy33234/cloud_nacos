...
public class TJScript {
    private static final Logger log = LoggerFactory.getLogger(TJScript.class)
    ...
    public void pay(Object[] args) {
        ...
        log.info("TJScript_Prepare_DataContentParms:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("TJScript_Prepare_resStr:{}", restr)
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("TJScript_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("TJScript_Query_reqMap:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("TJScript_Query_resStr:{}", resStr)
        ...
        if (returnJson != null && returnJson.getBoolean("result")) {
            ...
            if (dataJson != null && "12" == (dataJson.getString("status"))) {
                //支付成功
