...
public class ZuiwenScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(ZuiwenScript_recharge.class)
    ...
    public void pay(Object[] args) {
        ...
        String toSign = params.get("merchantNum") + params.get("orderNo")  + params.get("amount") + params.get("notifyUrl") + account.getPrivateKey()
        params.put("sign", MD5.md5(toSign))
        log.info("ZuiwenScript_recharge_prepare_params = {}", JSON.toJSONString(params))
        ...
        log.info("ZuiwenScript_recharge_prepare_resp = {}", resStr)
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("ZuiwenScript_notify_resp:{}", JSON.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("ZuiwenScript_query_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("ZuiwenScript_query_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
        JSONObject json = JSON.parseObject(resStr)
