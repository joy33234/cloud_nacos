...
class HuiCaiScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(HuiCaiScript_recharge.class)
    ...
    private void prepareScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount payment, RechargePrepareDO req, GlRechargeResult result, String paymentType) {
        ...
        log.info("HuiCaIScript_Prepare_Params:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("HuiCaIScript_Prepare_resStr:{}", restr)
    ...
    RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("HuiCaIScript_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("HuiCaIScript_Query_reqMap:{}", JSON.toJSONString(DataContentParms))
        ...
        log.info("HuiCaIScript_Query_resStr:{}", resStr)
        ...
        JSONObject dataJSON = json.getJSONObject("data");
        //订单状态。0:成功  1:失败 17：等待玩家付款
        if (dataJSON != null && "0" == dataJSON.getString("statusSt")) {
