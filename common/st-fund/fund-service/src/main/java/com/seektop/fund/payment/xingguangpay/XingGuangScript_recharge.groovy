 ...
 * @auth joy
 */
public class XingGuangScript_recharge {


    private static final Logger log = LoggerFactory.getLogger(XingGuangScript_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String payType) throws GlobalException {
        ...
        params.put("orderTime", DateUtils.format(req.getCreateDate(), DateUtils.YYYY_MM_DD_HH_MM_SS))
        ...
        log.info("XingGuangScript_recharge_prepare_params:{}", JSON.toJSONString(params))
        ...
        log.info("XingGuangScript_recharge_prepare_resp:{}", resStr)
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("XingGuangScript_notify_resp:{}", JSON.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("XingGuangScript_query_params:{}", JSON.toJSONString(params))
        ...
        resStr = decrypt(resStr, account.getPrivateKey())
        log.info("XingGuangScript_query_resp:{}", resStr)
