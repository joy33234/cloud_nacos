package com.seektop.fund.payment.virtualPay
...
class VirtualScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(VirtualScript_recharge.class)
    ...
    void pay(Object[] args) {
        ...
        result.setErrorMsg("当前充值繁忙，请稍后再试")
        return
    }
