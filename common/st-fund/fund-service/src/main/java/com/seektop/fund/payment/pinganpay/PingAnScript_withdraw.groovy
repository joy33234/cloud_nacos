    package com.seektop.fund.payment.pinganpay
 ...
 */
    ...
    public class PingAnScript_withdraw {
        private static final Logger log = LoggerFactory.getLogger(PingAnScript_withdraw.class)
        ...
        WithdrawResult withdraw(Object[] args) throws GlobalException {
            ...
            log.info("PingAnScript_Transfer_params: {}", JSON.toJSONString(DataContentParms))
            ...
            log.info("PingAnScript_Transfer_resStr: {}", resStr)
        ...
        WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
            ...
            log.info("PingAnScript_withdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
            ...
            log.info("PingAnScript_TransferQuery_order:{}", JSON.toJSONString(DataContentParms))
            GlRequestHeader requestHeader =
            ...
            log.info("PingAnScript_TransferQuery_resStr:{}", resStr)
        ...
        BigDecimal balanceQuery(Object[] args)  {
            ...
            log.info("PingAnScript_QueryBalance_reqMap: {}", JSON.toJSONString(DataContentParams))
            String resStr = okHttpUtil.post(merchantAccount.getPayUrl() + "/InterfaceV6/GetBalanceAmount/", DataContentParams, requestHeader)
            log.info("PingAnScript_QueryBalance_resStr: {}", resStr)
