 ...
 * @date 2021-07-26
 */
public class ChangChengScript_recharge {

    private static final Logger log = LoggerFactory.getLogger(ChangChengScript_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String productId)  {
        ...
        params.put("param1", req.getFromCardUserName())

        String toSign = MD5.toAscii(params) + "&key=" + account.getPrivateKey()
        params.put("sign", MD5.md5(toSign).toUpperCase())

        Map<String, String> params2 = new HashMap<>()
        params2.put("params", JSON.toJSONString(params))
        params2.put("param1", req.getFromCardUserName())
        ...
        log.info("ChangChengScript_recharge_prepare_params = {}", JSONObject.toJSONString(params2))
        String resStr = okHttpUtil.post(account.getPayUrl() + "/api/pay/create_order", params2, requestHeader)
        log.info("ChangChengScript_recharge_prepare_resp = {}", resStr)
        ...
        if ("SUCCESS" != (json.getString("retCode")) || StringUtils.isEmpty(dataJSON.getString("payUrl"))) {
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("ChangChengScript_notify = {}", JSONObject.toJSONString(resMap))
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("ChangChengScript_query_params:{}", JSON.toJSONString(params))
        ...
        String resp = okHttpUtil.post(account.getPayUrl() + "/api/pay/query_order", params2, requestHeader)
        log.info("ChangChengScript_query_resp:{}", resp)
