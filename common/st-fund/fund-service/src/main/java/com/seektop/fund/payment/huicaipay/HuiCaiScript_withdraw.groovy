    package com.seektop.fund.payment.huicaipay
    ...
    public class HuiCaiScript_withdraw {
        private static final Logger log = LoggerFactory.getLogger(HuiCaiScript_withdraw.class)
        ...
        WithdrawResult withdraw(Object[] args) throws GlobalException {
            ...
            log.info("HuiCaiScript_Transfer_params: {}", JSON.toJSONString(DataContentParms))
            ...
            log.info("HuiCaiScript_Transfer_resStr: {}", resStr)
            ...
            if (!json.getBoolean("success") || json.getString("code") != "0") {
                result.setValid(false)
        ...
        WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
            ...
            log.info("HuiCaiScript_withdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
            ...
            log.info("HuiCaiScript_TransferQuery_order:{}", JSON.toJSONString(DataContentParms))
            GlRequestHeader requestHeader =
            ...
            log.info("HuiCaiScript_TransferQuery_resStr:{}", resStr)

            JSONObject json = JSON.parseObject(resStr)
            if (json == null || !json.getBoolean("success") || json.getString("code") != "0") {
                return null
            }
            ...
            //订单状态判断标准：状态。0:成功  1:失败   15:退回
            if (dataJSON.getString("status") == "0") {
                notify.setStatus(0)
            } else if (dataJSON.getString("status") == "1" || dataJSON.getString("status") == "15") {
                notify.setStatus(1)
            } else {
                notify.setStatus(2)
            }
        ...
        BigDecimal balanceQuery(Object[] args)  {
            ...
            log.info("HuiCaiScript_QueryBalance_reqMap: {}", JSON.toJSONString(DataContentParams))
            String resStr = okHttpUtil.post(merchantAccount.getPayUrl() + "/api/merchant/info", DataContentParams, requestHeader)
            log.info("HuiCaiScript_QueryBalance_resStr: {}", resStr)
