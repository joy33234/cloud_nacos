 ...
 * @auth Otto
 */
public class QiDianScript_recharge {


    private static final Logger log = LoggerFactory.getLogger(QiDianScript_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String payType) throws GlobalException {
        ...
        log.info("QiDianScript_recharge_prepare_Params:{}", JSON.toJSONString(params))
        ...
        log.info("QiDianScript_recharge_prepare_resp:{} , orderId :{}", resStr , req.getOrderId() )
    ...
    public RechargeNotify notify(Object[] args) throws GlobalException {
        ...
        log.info("QiDianScript_notify_resp:{}", JSON.toJSONString(resMap))
        ...
        log.info("QiDianScript_notify_Sign: 回调资料错误或验签失败，单号：{}" , orderId )
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("QiDianScript_query_headParams:{}", JSON.toJSONString(params))
        ...
        log.info("QiDianScript_query_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
