...
class FuTaiLangV2Script_withdraw {

    private static final Logger log = LoggerFactory.getLogger(FuTaiLangV2Script_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        paramMap.put("pay_bank_name", glPaymentChannelBankBusiness.getBankName(req.getBankId(), merchantAccount.getChannelId()))
        paramMap.put("pay_sub_branch", "支行")
        ...
        log.info("FuTaiLangV2Script_Transfer_Params: {}", JSON.toJSONString(paramMap))
        ...
        log.info("FuTaiLangV2Script_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("FuTaiLangV2Script_Transfer_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("FuTaiLangV2Script_Transfer_Query_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        log.info("FuTaiLangV2Script_Transfer_Query_resStr: {}", resStr)
        ...
        notify.setRemark(dataJSON.getString("message"))
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("FuTaiLangV2Script_Query_Balance_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        log.info("FuTaiLangV2Script_Query_Balance_resStr: {}", resStr)
