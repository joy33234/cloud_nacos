    package com.seektop.fund.payment.eightyeightPay
 ...
 */
    ...
    public class EightyeightScript_withdraw {
        private static final Logger log = LoggerFactory.getLogger(EightyeightScript_withdraw.class)
        ...
        WithdrawResult withdraw(Object[] args) throws GlobalException {
            ...
            log.info("EightyeightScript_Transfer_params: {}", JSON.toJSONString(DataContentParms))
            ...
            log.info("EightyeightScript_Transfer_resStr: {}", resStr)
        ...
        WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
            ...
            log.info("EightyeightScript_withdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
            ...
            log.info("EightyeightScript_TransferQuery_order:{}", JSON.toJSONString(DataContentParms))
            GlRequestHeader requestHeader =
            ...
            log.info("EightyeightScript_TransferQuery_resStr:{}", resStr)
        ...
        BigDecimal balanceQuery(Object[] args)  {
            ...
            log.info("EightyeightScript_QueryBalance_reqMap: {}", JSON.toJSONString(DataContentParams))
            ...
            log.info("EightyeightScript_QueryBalance_resStr: {}", resStr)
