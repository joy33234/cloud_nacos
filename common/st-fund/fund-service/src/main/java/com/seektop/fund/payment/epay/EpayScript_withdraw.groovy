 ...
 */
    ...
    public class EpayScript_withdraw {
        private static final Logger log = LoggerFactory.getLogger(EpayScript_withdraw.class)
        ...
        WithdrawResult withdraw(Object[] args) throws GlobalException {
            ...
            log.info("EpayScript_Transfer_params: {}", JSON.toJSONString(DataContentParms))
            ...
            log.info("EpayScript_Transfer_resStr: {}", resStr)
        ...
        WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
            ...
            log.info("EpayScript_withdrawNotify_resMap:{}", JSON.toJSONString(resMap))
            String orderId = resMap.get("custNo")

            String originalSign = resMap.remove("sign")
            resMap.put("secret", merchant.getPrivateKey())
            String sign = MD5.md5( MD5.toAscii(resMap))

            if (StringUtils.isNotEmpty(orderId) &&  originalSign == sign) {
        ...
        WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
            ...
            log.info("EpayScript_TransferQuery_order:{}", JSON.toJSONString(DataContentParms))
            GlRequestHeader requestHeader =
            ...
            log.info("EpayScript_TransferQuery_resStr:{}", resStr)
        ...
        BigDecimal balanceQuery(Object[] args)  {
            ...
            log.info("EpayScript_QueryBalance_reqMap: {}", JSON.toJSONString(DataContentParams))
            String resStr = okHttpUtil.post(merchantAccount.getPayUrl() + "/service/queryBalance", DataContentParams, requestHeader)
            log.info("EpayScript_QueryBalance_resStr: {}", resStr)
