package com.seektop.fund.payment.gtV3Pay
 ...
 * @auth Otto
 */
class GtV3PayScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(GtV3PayScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("GtV3PayScript_Transfer_params: {} , url: {}", JSON.toJSONString(params), merchantAccount.getPayUrl())
        ...
        log.info("GtV3PayScript_Transfer_resStr: {} , orderId :{}", resStr , req.getOrderId())
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        this.glPaymentChannelBankBusiness = com.seektop.fund.payment.groovy.BaseScript.getResource(args[3], ResourceEnum.GlPaymentChannelBankBusiness) as GlPaymentChannelBankBusiness
        log.info("GtV3PayScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        if (StringUtils.isNotEmpty(orderId) && thirdSign == md5Sign) {
            ...
            log.info("GtV3PayScript_WithdrawNotify_Sign: 回调资料错误或验签失败，orderId：{}" , orderId )
            return null
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("GtV3PayScript_TransferQuery_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("GtV3PayScript_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("GtV3PayScript_QueryBalance_reqMap: {}", JSON.toJSONString(params))
        ...
        log.info("GtV3PayScript_QueryBalance_resStr: {}", resStr)
