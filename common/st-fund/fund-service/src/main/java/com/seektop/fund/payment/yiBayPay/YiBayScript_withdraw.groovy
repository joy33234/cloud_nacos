 ...
 * @auth Otto
 */
class YiBayScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(YiBayScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("YiBayScript_Transfer_params: {}", params)
        ...
        log.info("YiBayScript_Transfer_resStr: {} ", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        this.glPaymentChannelBankBusiness = BaseScript.getResource(args[3], ResourceEnum.GlPaymentChannelBankBusiness) as GlPaymentChannelBankBusiness
        log.info("YiBayScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
        ...
        if (StringUtils.isNotEmpty(notifyMap.get("orderno")) || md5Sign == notifyMap.get("sign")) {
            ...
            log.info("YiBayPayScript_WithdrawNotify_sign: 回调资料错误或验签失败，单号：{}" , notifyMap.get("orderno") )
            return null
        }
    }
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("YiBayScript_TransferQuery_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("YiBayScript_TransferQuery_resStr:{}", resStr)
        ...
        if ("0" == json.getString("systate")) {
            ...
            if (MD5.md5(toSign) != dataJSON.getString("sign")) {
                log.info("YiBayScript_withdrawQuery _sign:{}, 验签失败 , 我方签名: {} , 三方签名:{} ", orderId, MD5.md5(toSign), dataJSON.getString("sign"))
                return null
            }
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("YiBayScript_QueryBalance_reqMap: {}", JSON.toJSONString(params))
        ...
        log.info("YiBayScript_QueryBalance_resStr: {}", resStr)
    ...
    public static String compareNumber(BigDecimal number){
        if (!"".equals(number) && number != null){
            if (new BigDecimal(number.intValue()).compareTo(number)==0){
                ...
                //小数
                return String.valueOf(number.setScale(2, RoundingMode.DOWN));
            }
        }
        return "";
    }
