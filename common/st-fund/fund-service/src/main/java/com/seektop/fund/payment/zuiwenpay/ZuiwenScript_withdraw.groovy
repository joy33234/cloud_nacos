package com.seektop.fund.payment.zuiwenpay
...
class ZuiwenScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(ZuiwenScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        String toSign = paramMap.get("merchantNum") + paramMap.get("orderNo") + paramMap.get("amount") + paramMap.get("notifyUrl") + merchantAccount.getPrivateKey();
        paramMap.put("sign", MD5.md5(toSign))
        log.info("ZuiwenScript_Transfer_Params: {}", JSON.toJSONString(paramMap))
        ...
        log.info("ZuiwenScript_Transfer_resStr: {}", resStr)
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("ZuiwenScript_Transfer_Notify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("ZuiwenScript_Transfer_Query_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        log.info("ZuiwenScript_Transfer_Query_resStr: {}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("ZuiwenScript_Query_Balance_Params: {}", JSON.toJSONString(paramMap))
        GlRequestHeader requestHeader =
        ...
        String resStr = okHttpUtil.get(merchantAccount.getPayUrl() + "/api/getMerchantAmt", paramMap,  requestHeader)
        log.info("ZuiwenScript_Query_Balance_resStr: {}", resStr)
        ...
        BigDecimal balance = dataJSON.getBigDecimal("withdrawableAmount")
