 ...
 * @auth otto
 */
public class XiHongShi2Script_recharge {

    private static final Logger log = LoggerFactory.getLogger(XiHongShi2Script_recharge.class)
    ...
    private void prepareToScan(GlPaymentMerchantApp merchant, GlPaymentMerchantaccount account, RechargePrepareDO req, GlRechargeResult result, String gateway) throws GlobalException {
        ...
        log.info("XiHongShi_recharge_prepare_params:{}", JSON.toJSONString(params))
        ...
        log.info("XiHongShi_recharge_prepare_resp:{} ,orderId:{}", resStr ,req.getOrderId())
        ...
        result.setThirdOrderId(dataJSON.getString("ptorder"))
        println(result)

    }

    public RechargeNotify notify(Object[] args) throws GlobalException {
        log.info("XiHongShi_notify_args:{}", args)
        this.okHttpUtil = args[0] as OkHttpUtil
        GlPaymentMerchantaccount account = args[2] as GlPaymentMerchantaccount
        Map<String, String> resMap = args[3] as Map<String, String>

        log.info("XiHongShi_notify_resp:{}", resMap)
    ...
    public RechargeNotify payQuery(Object[] args) throws GlobalException {
        ...
        log.info("XiHongShi_query_params:{}", JSON.toJSONString(params))
        ...
        log.info("XiHongShi_query_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
        ...
        if( MD5.md5(toSign) != dataJSON.getString("sign")){
            log.info("XiHongShi_payQuery_sign:{} 验签失败 , 我方签名: {} , 三方签名:{} ",  orderId , MD5.md5(toSign) , dataJSON.getString("sign") )
            return null
        }
