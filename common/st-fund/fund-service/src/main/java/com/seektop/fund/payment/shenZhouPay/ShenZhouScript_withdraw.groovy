 ...
 * @auth Otto
 */
class ShenZhouScript_withdraw {

    private static final Logger log = LoggerFactory.getLogger(ShenZhouScript_withdraw.class)
    ...
    WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("ShenZhouScript_Transfer_params: {}", params)
        ...
        log.info("ShenZhouScript_Transfer_resStr: {} , orderId:{}", resStr , req.getOrderId())
    ...
    WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        //三方表示无主动回调功能 2021/12/08
        log.info("ShenZhouScript_WithdrawNotify_resMap:{}", JSON.toJSONString(resMap))
    ...
    WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("ShenZhouScript_TransferQuery_reqMap:{}", JSON.toJSONString(params))
        ...
        log.info("ShenZhouScript_TransferQuery_resStr:{}", resStr)
    ...
    BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("ShenZhouScript_QueryBalance_reqMap: {}", JSON.toJSONString(params))
        ...
        log.info("ShenZhouScript_QueryBalance_resStr: {}", resStr)
