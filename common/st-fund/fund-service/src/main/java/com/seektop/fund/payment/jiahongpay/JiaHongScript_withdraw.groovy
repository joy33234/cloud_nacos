package com.seektop.fund.payment.jiahongpay
 ...
 * @auth joy
 */
public class JiaHongScript_withdraw {


    private static final Logger log = LoggerFactory.getLogger(JiaHongScript_withdraw.class)
    ...
    public WithdrawResult withdraw(Object[] args) throws GlobalException {
        ...
        log.info("JiaHongScript_doTransfer_params:{}", JSON.toJSONString(params))
        ...
        log.info("JiaHongScript_doTransfer_resp:{}", resStr)
    ...
    public WithdrawNotify withdrawNotify(Object[] args) throws GlobalException {
        ...
        log.info("JiaHongScript_doTransferNotify_resp:{}", JSON.toJSONString(resMap))
    ...
    public WithdrawNotify withdrawQuery(Object[] args) throws GlobalException {
        ...
        log.info("JiaHongScript_doTransferQuery_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("JiaHongScript_doTransferQuery_resp:{}", resStr)
        if (StringUtils.isEmpty(resStr)) {
            return null
        }
        JSONObject json = JSON.parseObject(resStr)
    ...
    public BigDecimal balanceQuery(Object[] args) throws GlobalException {
        ...
        log.info("JiaHongScript_queryBalance_params:{}", JSON.toJSONString(params))
        GlRequestHeader requestHeader =
        ...
        log.info("JiaHongScript_queryBalance_resp:{}", resStr)
