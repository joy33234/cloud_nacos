        ...
        <div style="display: flex;justify-content: center;">
          <div style="margin-bottom: 20px;">
            <div v-if="isRegist" class="mb15">
              <input class="login_input nick_name" v-model="nickname" type="text" placeholder="nickname" autofocus>
            </div>
            <div class="mb15">
              <input class="login_input" type="text" v-model="username" placeholder="account " autofocus>
            </div>
            <div class="mb15">
...
async function hanleLogin() {
  ...
  const { code, data,msg } = await login( username.value, password.value, false)
  if (code == 200) {
...
.login_btn::after {
  ...
  font-size: 36px;
  font-family: 'Bebas Neue', cursive;
  background: linear-gradient(45deg, transparent 5%, #9ad1f1 5%);
  border: 0;
  letter-spacing: 3px;
  /* line-height: 88px; */
  color: #fff;
