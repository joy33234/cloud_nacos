<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="帐号" prop="accountName">
        <el-input
...
<script>
import { listBuy, getBuy, delBuy, addBuy, updateBuy, refreshCache } from "@/api/okx/buy";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listBuy(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
