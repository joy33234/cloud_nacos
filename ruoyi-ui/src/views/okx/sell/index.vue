...
<script>
import { listSell, getSell, delSell, addSell, updateSell, refreshCache } from "@/api/okx/sell";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listSell(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/sell/export', {
        ...this.queryParams
